...
import '../../Network/Models/RechargeReportInfoData.dart';
import '../FunctionUtils.dart';
import '../ImageConstant.dart';

class BillPdf {
  static Future<pw.Document> generatePdf(
      RechargeReportInfoData data, int amount) async {
                    ...
                    children: [
                      ...
                      pw.Container(
                          ...
                          child: pw.Column(children: [
                            ...
                            pw.Text('Mobile No: ${data.mobileNo}',
                                style: pw.TextStyle(
                                    fontSize: 12,
                                    fontWeight: pw.FontWeight.bold)),
                            pw.Text(
                ...
                children: [
                  ...
                  pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                          ...
                          border:
                              pw.Border.all(color: PdfColors.black, width: 1)),
                      child: pw.Text(data.customerName ?? "",
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)))
                ],
              ),
                ...
                children: [
                  pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                          ...
                          border:
                              pw.Border.all(color: PdfColors.black, width: 1)),
                      child: pw.Text('Customer Mobile No.',
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)),
                      height: 35,
                      width: 170),
                  pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                          ...
                          border:
                              pw.Border.all(color: PdfColors.black, width: 1)),
                      child: pw.Text(data.mobileNo ?? "NA",
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)))
                ],
              ),
                ...
                children: [
                  pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                          ...
                          border:
                              pw.Border.all(color: PdfColors.black, width: 1)),
                      child: pw.Text('Customer Account No.',
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)),
                      height: 35,
                      width: 170),
                ...
                children: [
                  ...
                  pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                          ...
                          border:
                              pw.Border.all(color: PdfColors.black, width: 1)),
                      child: pw.Text(data.operatorName ?? "",
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)))
                ],
              ),
